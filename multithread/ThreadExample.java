...
public class ThreadExample extends Thread
{
	public void run()
	{
		System.out.println("running is thread name is:"+Thread.currentThread().getName());
		System.out.println("running is thread priority is:"+Thread.currentThread().getPriority());
	}
